    ...
    private function addWaterMark($file)
    {
        ...
        switch ($watermark_type) {
                ...
                $watermark_text = $this->watermark_string;
                    ...
                    $watermark_width = imagefontwidth(5) * ($watermark_text_count + 2); //字体宽度,留2px边距
                    $watermark_height = imagefontheight(5) + 2; //字体高度,留2px边距
                    ...
                    imagestring($nimage, 5, $x1 + 2, $y1 + 2, $this->watermark_string, $gray); //留边距
                    break;
                case 'image': //加水印图片
